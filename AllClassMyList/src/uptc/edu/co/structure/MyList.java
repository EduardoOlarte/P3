...
public class MyList<T> implements List<T> {
	...
	public int lastIndexOf(Object o) {
		...
		/*
		 * Node<T> aux = last; int size = size();
		 * 
		 * while (aux != null) { if (aux.getData().equals(o)) { return size; }
		 * aux.getPrevious(); size--; } return -1; Este metodo es un ejemplo de como se
		 * podria hacer usando la implementacion de la variable last pero, la
		 * implementacion del metodo se deja como la antigua ya que es mucho mas eficaz
		 */
